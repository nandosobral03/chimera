<script lang="ts">
    ...
    const heatmapColors = ["#03071e","#370617","#6a040f","#9d0208","#d00000","#dc2f02","#f77f31","#ffa32b","#ebd87c  "].reverse();
	...
	{#each numberedBoard as row, i}
		{#each row as cell, j}
			<div
				...
				style={`width: ${cellSize}px; height: ${cellSize}px; ${cell.value == -1 ? "background-color:" + getBombColor(i, j) + "; color: " + getBombColorText(i,j) : ''};`}
			>
